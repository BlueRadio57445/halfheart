give Blue_Radio minecraft:diamond_block{display:{Name:'{"text":"昂貴方塊", "color":"green"}'}}

give @s minecraft:quartz{tp:1b, display:{Name:'{"text": "未充能的傳送水晶","italic": false}', Lore:['{"text": "按Q鍵以充能", "color": "gray", "italic": false}']}}
...
give @s minecraft:pink_dye{touch:['lost_ai'],display:{Name:'{"text":"失魂丸", "italic": false}', Lore:['[{"text": "","italic": false, "color": "gray"}, {"text": "類型:"}, {"text": "接觸毒", "color": "green"}]', '[{"text": "被接觸的非玩家生物會喪失魂魄","italic": false, "color": "gray"}]', '[{"text": "，只對空手的生物有用","italic": false, "color": "gray"}]']}}

give @s minecraft:gray_dye{touch:['slow'],display:{Name:'{"text":"沉履丸", "italic": false}', Lore:['[{"text": "","italic": false, "color": "gray"}, {"text": "類型:"}, {"text": "接觸毒", "color": "green"}]', '[{"text": "被接觸的生物會行動遲緩","italic": false, "color": "gray"}]']}}
...
give @s minecraft:potion{drink:['harming'],Potion:"poison",display:{Name:'{"text":"嘔噁", "italic": false}', Lore:['[{"text": "","italic": false, "color": "gray"}, {"text": "類型:"}, {"text": "飲食毒", "color": "gold"}]', '[{"text": "使用後會中毒","italic": false, "color": "gray"}]']}}

give @s minecraft:potion{CustomPotionEffects:[{Id:17b, Duration:300, Amplifier:50b}],display:{Name:'{"text":"餓藥", "italic": false}', Lore:['[{"text": "","italic": false, "color": "gray"}, {"text": "類型:"}, {"text": "飲食毒", "color": "gold"}]', '[{"text": "如果還沒餓，就是隱藏飽食度還沒消耗完","italic": false, "color": "gray"}]']}}

give @s minecraft:potion{CustomPotionEffects:[{Id:15b, Duration:300, Amplifier:0b}],CustomPotionColor:65802,display:{Name:'{"text":"瞽蠱", "italic": false}', Lore:['[{"text": "","italic": false, "color": "gray"}, {"text": "類型:"}, {"text": "飲食毒", "color": "gold"}]', '[{"text": "讓中毒的人失明","italic": false, "color": "gray"}]']}}

give @s minecraft:splash_potion{splash:['harming'],Potion:"harming",display:{Name:'{"text":"驟虫", "italic": false}', Lore:['[{"text": "","italic": false, "color": "gray"}, {"text": "類型:"}, {"text": "灑毒", "color": "blue"}]', '[{"text": "即使是綠洫也會中毒，相當危險","italic": false, "color": "gray"}]']}}

give @s minecraft:splash_potion{splash:['healing'],Potion:"healing",display:{Name:'{"text":"剋歹", "italic": false}', Lore:['[{"text": "","italic": false, "color": "gray"}, {"text": "類型:"}, {"text": "灑毒", "color": "blue"}]', '[{"text": "對不死生物來說是毒藥","italic": false, "color": "gray"}]']}}
